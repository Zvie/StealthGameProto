...
// End Cross Module References
...
#endif
			auto NewProp_bIsSprinting_SetBit = [](void* Obj){ ((AFPSCharacter*)Obj)->bIsSprinting = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsSprinting = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsSprinting", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000014, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(AFPSCharacter), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bIsSprinting_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bIsSprinting_MetaData, ARRAY_COUNT(NewProp_bIsSprinting_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AFPSCharacter, 1172420256);
