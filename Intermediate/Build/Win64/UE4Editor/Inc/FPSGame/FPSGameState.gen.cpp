...
// End Cross Module References
	...
	void AFPSGameState::MulticastOnMissionComplete(APawn* InstigatorPawn, bool bMissionComplete)
	{
	...
	UFunction* Z_Construct_UFunction_AFPSGameState_MulticastOnMissionComplete()
	{
		...
		if (!ReturnFunction)
		{
			auto NewProp_bMissionComplete_SetBit = [](void* Obj){ ((FPSGameState_eventMulticastOnMissionComplete_Parms*)Obj)->bMissionComplete = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bMissionComplete = { UE4CodeGen_Private::EPropertyClass::Bool, "bMissionComplete", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FPSGameState_eventMulticastOnMissionComplete_Parms), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bMissionComplete_SetBit)>::SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	UClass* Z_Construct_UClass_AFPSGameState()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_AFPSGameState_MulticastOnMissionComplete, "MulticastOnMissionComplete" }, // 2015007290
			};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AFPSGameState, 681676382);
