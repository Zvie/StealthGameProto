...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AFPSExtractionZone()
	{
		...
		if (!OuterClass)
		{
...
#endif
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ObjectiveCompleteSound_MetaData[] = {
				{ "Category", "Sounds" },
				{ "ModuleRelativePath", "Public/FPSExtractionZone.h" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ObjectiveCompleteSound = { UE4CodeGen_Private::EPropertyClass::Object, "ObjectiveCompleteSound", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000010001, 1, nullptr, STRUCT_OFFSET(AFPSExtractionZone, ObjectiveCompleteSound), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(NewProp_ObjectiveCompleteSound_MetaData, ARRAY_COUNT(NewProp_ObjectiveCompleteSound_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ObjectiveCompleteSound,
	...
	IMPLEMENT_CLASS(AFPSExtractionZone, 4153759908);
