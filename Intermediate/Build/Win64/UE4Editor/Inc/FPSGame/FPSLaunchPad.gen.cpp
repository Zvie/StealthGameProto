...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AFPSLaunchPad()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_AFPSLaunchPad_OverlapLaunchPad, "OverlapLaunchPad" }, // 216529945
			};
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_LaunchPitchAngle_MetaData[] = {
				{ "Category", "LaunchPad" },
				{ "ModuleRelativePath", "Public/FPSLaunchPad.h" },
				{ "ToolTip", "angle added on top of actor rotation to launch the character\n      marked 'edit instance only' to allow in-level editing of this property per instance." },
			};
#endif
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ActivateLaunchPadEffect_MetaData[] = {
				{ "Category", "LaunchPad" },
				{ "ModuleRelativePath", "Public/FPSLaunchPad.h" },
				{ "ToolTip", "Effect to play when activating the launch pad" },
			};
#endif
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ArrowComp = { UE4CodeGen_Private::EPropertyClass::Object, "ArrowComp", RF_Public|RF_Transient|RF_MarkAsNative, 0x00200800000a0009, 1, nullptr, STRUCT_OFFSET(AFPSLaunchPad, ArrowComp), Z_Construct_UClass_UArrowComponent_NoRegister, METADATA_PARAMS(NewProp_ArrowComp_MetaData, ARRAY_COUNT(NewProp_ArrowComp_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ArrowComp,
	...
	IMPLEMENT_CLASS(AFPSLaunchPad, 97745775);
