...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AFPSObjectiveActor()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_PickUpSoundFX = { UE4CodeGen_Private::EPropertyClass::Object, "PickUpSoundFX", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000010001, 1, nullptr, STRUCT_OFFSET(AFPSObjectiveActor, PickUpSoundFX), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(NewProp_PickUpSoundFX_MetaData, ARRAY_COUNT(NewProp_PickUpSoundFX_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_PickUpSoundFX,
	...
	IMPLEMENT_CLASS(AFPSObjectiveActor, 3499855625);
