...
void AFPSCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Sprint", IE_Pressed, this, &AFPSCharacter::IsSprinting);
	PlayerInputComponent->BindAction("Sprint", IE_Released, this, &AFPSCharacter::IsntSprinting);
...
void AFPSCharacter::IsntSprinting()
{
	bIsSprinting = false;
